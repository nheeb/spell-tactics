...
static var on_tile_hovered: Signal = Utility.create_static_signal(PAHoverTile, "on_tile_hovered")
static var on_drainable_tile_hovered: Signal = Utility.create_static_signal(PAHoverTile, "on_drainable_tile_hovered")
static var on_drainable_tile_unhovered: Signal = Utility.create_static_signal(PAHoverTile, "on_drainable_tile_unhovered")
