...
static var on_tile_hovered: Signal = GeneralUtilityClass.create_static_signal(PATileHoverUpdate, "on_tile_hovered")
static var on_drainable_tile_hovered: Signal = GeneralUtilityClass.create_static_signal(PATileHoverUpdate, "on_drainable_tile_hovered")
static var on_drainable_tile_unhovered: Signal = GeneralUtilityClass.create_static_signal(PATileHoverUpdate, "on_drainable_tile_unhovered")
