...
func _enter_tree():
	...
	_editor_ui = preload("res://Logic/LevelEditor/LevelEditor/UI/EditorUI.tscn").instantiate()
...
func _make_visible(visible):
	...
	if visible:
		_selection_ui = preload("res://Logic/LevelEditor/LevelEditor/UI/SelectionUI.tscn").instantiate()
